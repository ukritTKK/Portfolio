...
describe('Mechanic CRUD permission test', () =>
{
  before((done) =>
  {
  ...
  describe('? "Check if Mechanic CRUD work":', () =>
  {
    ...
    before(function(done)
    {
      ...
      (// start of functions flow here
        ...
        function(arg,callback)
        {
          ...
          let route = '/api/mechanics/mechanic';
          // let arg = request;
          let obj = {garage_id:'zJELcGlf1gsjbcqy',name:'thanawat mangnee',tel:'089-999-9999',rating:'4',service_amount:'3'}
          testController.testGetAPI(callback,arg,route,
            tmpRequest = chai.request(server).post(route).field('garage_id',obj.garage_id)
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/mechanic',reqNo = 9;
            if(arg.output[2].res.hasOwnProperty('body')
            && arg.output[2].res.body.hasOwnProperty('obj')
            && arg.output[2].res.body.obj.hasOwnProperty('_id') )
              route += '/'+arg.output[2].res.body.obj._id;
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/mechanic',reqNo = 11;
            if(arg.output[2].res.hasOwnProperty('body')
            && arg.output[2].res.body.hasOwnProperty('obj')
            && arg.output[2].res.body.obj.hasOwnProperty('_id') )
              route += '/'+arg.output[2].res.body.obj._id;
    ...
    // start of test here
    it('when called postMechanic, the route should not be found', (done) =>
    {
    ...
    it('should return the response properly if you submit putMechanicImg with an image', (done) =>
    {
      let reqNo = 14;
    ...
    before(function(done)
    {
      ...
      (// start of functions flow here
        ...
        function(arg,callback)
        {
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/part',reqNo = 9;
            // console.log('arg.output = ')
            // console.log(arg.output)
            if(arg.output[6].res.hasOwnProperty('body')
            && arg.output[6].res.body.hasOwnProperty(0)
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/part',reqNo = 11;
            if(arg.output[6].res.hasOwnProperty('body')
            && arg.output[6].res.body.hasOwnProperty(0)
            && arg.output[6].res.body[0].hasOwnProperty('_id') )
              route += '/'+arg.output[6].res.body[0]._id;
    ...
    before(function(done)
    {
      ...
      (// start of functions flow here
        ...
        function(arg,callback)
        {
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/car',reqNo = 9;
            route += '/'+arg.output[6].res.body[0]._id;
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/car',reqNo = 11;
            route += '/'+arg.output[6].res.body[0]._id;
    ...
    before(function(done)
    {
      ...
      (// start of functions flow here
        ...
        function(arg,callback)
        {
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/user',reqNo = 7;
            if(arg.output[5].res.hasOwnProperty('body')
            && arg.output[5].res.body.hasOwnProperty(0)
            && arg.output[5].res.body[0].hasOwnProperty('_id') )
              route += '/'+arg.output[5].res.body[0]._id;
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/user',reqNo = 10;
            if(arg.output[5].res.hasOwnProperty('body')
            && arg.output[5].res.body.hasOwnProperty(0)
            && arg.output[5].res.body[0].hasOwnProperty('_id') )
              route += '/'+arg.output[5].res.body[0]._id;
  ...
  describe('? "Check if Garage CRUD work":', () =>
  {
    ...
    before(function(done)
    {
      ...
      (// start of functions flow here
        ...
        // function(callback)
        // {
        //   let route = '/api/mechanics/garage';
        //   let arg = request;
        //   let obj ={
        //     "name":"Toyotacare",
        //     "tel":"089-999-9999",
        ...
        function(arg,callback)
        {
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/garage',reqNo = 7;
            // console.log('arg.output = ')
            // console.log(arg.output)
            // console.log(arg.output[2].res.body[0])
            if(arg.output[5].res.hasOwnProperty('body')
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/garage',reqNo = 10;
            if(arg.output[5].res.hasOwnProperty('body')
            && arg.output[5].res.body.hasOwnProperty(0)
            && arg.output[5].res.body[0].hasOwnProperty('_id') )
              route += '/'+arg.output[5].res.body[0]._id;
  ...
  describe('? "Check if Service CRUD work":', () =>
  {
    ...
    before(function(done)
    {
      ...
      (// start of functions flow here
        ...
        function(arg,callback)
        {
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/service',reqNo = 9;
            // console.log('arg.output = ')
            // console.log(arg.output)
            // console.log('arg.output[2].res.body =')
            // console.log(arg.output[2].res.body);
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/service',reqNo = 11;
            route += '/'+arg.output[6].res.body[0]._id;
            // let obj = {id:arg.output[2].res.body[0]._id};
            testController.testGetAPI(callback,arg,route,tmpRequest = chai.request(server).delete(route).set('Content-Type','application/x-www-form-urlencoded').set('Authorization',token),isDebug=isDebugTest);
          }, // request 11
    ...
    it('the record should had been created when called postService', (done) =>
    {
      ...
      // guess that mechanic_id is different because it used another mechanic user that previously existed from the test before, so I will make an exception here
      for(var argName in obj)
        if(argName!="repair_list" && argName!="status_list" && argName!="part_id_list" && argName!="service_date" && argName!="mechanic_id")
        {
      ...
      reqNo = 5;
      for(var argName in obj)
        if(argName!="repair_list" && argName!="status_list" && argName!="part_id_list" && argName!="service_date" && argName!="mechanic_id") request.output[reqNo].docs[argName].should.be.eql(obj[argName])
      done();
    })
  ...
  describe('? "Check if Request CRUD work":', () =>
  {
    ...
    before(function(done)
    {
      ...
      (// start of functions flow here
        ...
        function(arg,callback)
        {
          ...
          jwt.verify(arg.output[reqNo-1].res.body.token, config.jwt.secret, function(err, decoded)
          {
            testController.testGetAPI(callback,arg,route,
              ...
              .field('name',obj.name).field('tel',obj.tel)
              .field('rating',obj.rating).field('service_amount',obj.service_amount)////.set('Content-Type','multipart/form-data')
              .field('user_id',decoded.id)//decoded.id)
              .attach('file',__dirname+'/../sample/LRG_DSC03836.JPG')
            .set('Authorization',token).send(obj),isDebug=isDebugTest);
          })
        }, // request 2
        ...
        function(arg,callback)
        {
          ...
          let obj = {
            user_id:"1",
            mechanic_id:arg.output[reqNo-2].res.body.obj._id,//"2",
            mechanic_reach:0,
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/request';
            testController.testGetAPI(callback,arg,route,tmpRequest = chai.request(server).get(route).set('Content-Type','application/x-www-form-urlencoded').set('Authorization',token),isDebug=isDebugTest);
          }, // request 6
          function(arg,callback)
          {
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/request',reqNo = 9;
            //console.log('arg.output = ')
            //console.log(arg.output)
            route += '/'+arg.output[6].res.body[0]._id;
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/request',reqNo = 11;
            route += '/'+arg.output[6].res.body[0]._id;
            // let obj = {id:arg.output[2].res.body[0]._id};
            testController.testGetAPI(callback,arg,route,tmpRequest = chai.request(server).delete(route).set('Content-Type','application/x-www-form-urlencoded').set('Authorization',token),isDebug=isDebugTest);
          }, // request 11
    ...
    it('the record should had been created when called postRequest', (done) =>
    {
      ...
      let obj = {
        user_id:"1",
        mechanic_id:request.output[reqNo-2].res.body.obj._id,//"2",
        mechanic_reach:0,
        location_lat:13.682659,
        location_lng:100.957553,
        request_time:'2016-06-03T10:34',
  ...
  describe('? "Check if Billing CRUD work":', () =>
  {
    ...
    before(function(done)
    {
      ...
      (// start of functions flow here
        ...
        {
          let reqNo = 5;
          let route = '/api/mechanics/billing';
          let obj = {
            user_id:"1",
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/billing',reqNo = 10;
            route += '/'+arg.output[7].res.body[0]._id;
            let obj = {price:10200};
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/billing',reqNo = 12;
            route += '/'+arg.output[7].res.body[0]._id;
            // let obj = {id:arg.output[2].res.body[0]._id};
            testController.testGetAPI(callback,arg,route,tmpRequest = chai.request(server).delete(route).set('Content-Type','application/x-www-form-urlencoded').set('Authorization',token),isDebug=isDebugTest);
          }, // request 12
  ...
  describe('? "Check if Promotion CRUD work":', () =>
  {
    ...
    before(function(done)
    {
      ...
      (// start of functions flow here
        ...
        {
          let reqNo = 4;
          let route = '/api/mechanics/promotion';
          token = arg.output[reqNo-1].res.body.token;
          let obj = {
            promotion_type:"winter sale",
            discount_price:1250,
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/promotion',reqNo = 9;
            //console.log('arg.output = ')
            //console.log(arg.output)
            route += '/'+arg.output[6].res.body[0]._id;
          ...
          function(arg,callback)
          {
            let route = '/api/mechanics/promotion',reqNo = 11;
            route += '/'+arg.output[6].res.body[0]._id;
            // let obj = {id:arg.output[2].res.body[0]._id};
            testController.testGetAPI(callback,arg,route,tmpRequest = chai.request(server).delete(route).set('Content-Type','application/x-www-form-urlencoded').set('Authorization',token),isDebug=isDebugTest);
          }, // request 11
  ...
  describe('? "Check if classDataWithUser work":', () =>
  {
    // start of variable here
    let request={ // just add the required input variable here, and we can put the output in the output section
                  account : {username:"test",password:"12345"},
    ...
    before(function(done)
    {
      ...
      (// start of functions flow here
        ...
        function(callback)
        {
          request.account.name = "Jay Gatsby";
          let arg = request, route = '/registerAdmin',obj=request.account;
          testController.testGetAPI(callback,arg,route,tmpRequest = chai.request(server).post(route).set('Content-Type','application/x-www-form-urlencoded').send(obj),isDebug=isDebugTest);
          // callback(null,request)
        }, // request0
        ...
        function(arg,callback)
        {
          ...
          let date1 = date2 = date3 = "2016-06-03T10:34"
          let obj ={
                      user_id:arg.output[3].res.body.id,
                      mechanic_id:arg.output[2].res.body.obj._id,//"1",
                      promotion_id:"6",
                      car_id:"7",
                      car_miles:90,
                      car_used_years:386,
        ...
        function(arg,callback)
        {
          let reqNo = 8;
          token = arg.output[3].res.body.token;
          let route = '/api/mechanics/classDataWithUser/service';
          // route += '/'+arg.output[2].res.body.obj._id;
          // let arg = request;
          let obj = {garage_id:'zJELcGlf1gsjbcqy',name:'thanawat mangnee',tel:'089-999-9999',rating:'4',service_amount:'3'}
          testController.testGetAPI(callback,arg,route,
    ...
    it('when called classDataWithUser, the route should show the data properly', (done) =>
    {
      let reqNo = 4;
      let obj = request.output[reqNo].res.body[0];
      for(var argName in obj)
    ...
    it("when called getClassDataWithUser mechanic with mechanic class, the route should only show the mechanic 's own data", (done) =>
    {
      let reqNo = 6;
      request.output[reqNo].res.status.should.be.eql(200);
      let obj = request.output[reqNo].res.body[0];
    ...
    it("when called getClassDataWithUser service with mechanic class, the route should only show the mechanic 's own service for the user", (done) =>
    {
      let reqNo = 8;
      let obj = request.output[reqNo].res.body[0];
      request.output[reqNo].res.status.should.be.eql(200);
      for(var argName in obj)
      {
        if(argName.length>4 && argName!='updatedAt' && argName!='createdAt' && argName!="repair_list" && argName!="status_list" && argName!="part_id_list" && argName!="service_date" && argName!="username" && argName!="userName")
          obj[argName].should.be.eql(request.output[reqNo+1].docs[argName])
        obj.createdAt.should.be.eql(request.output[reqNo+1].docs.createdAt.toISOString())
        obj.updatedAt.should.be.eql(request.output[reqNo+1].docs.updatedAt.toISOString())
        obj.service_date.should.be.eql(request.output[reqNo+1].docs.service_date.toISOString())
        obj.username.should.be.eql(request.output[3].res.body.username)
        obj.userName.should.be.eql(request.account.name)
      }
      done();
    });
  });//end of template here
